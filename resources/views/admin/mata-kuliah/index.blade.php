            ...
            <div class="modal-body">
                <form id="form-tambah">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control {{ $errors->has('kode_matakuliah') ? 'is-invalid' : '' }}" id="kode_matakuliah" name="kode_matakuliah" required>
                        <span class="text-danger" id="kode_matakuliah_error"></span>
                    </div>
                    <div class="form-group mb-3">
                        <label for="nama_matakuliah">Nama Mata Kuliah</label>
                        <input type="text" class="form-control {{ $errors->has('nama_matakuliah') ? 'is-invalid' : '' }}" id="nama_matakuliah" name="nama_matakuliah" required>
                        <span class="text-danger" id="nama_matakuliah_error"></span>
                    </div>
                    <div class="form-group mb-3">
                        <label for="sks">SKS</label>
                        <input type="number" class="form-control {{ $errors->has('sks') ? 'is-invalid' : '' }}" id="sks" name="sks" min="1" max="6" required>
                        <span class="text-danger" id="sks_error"></span>
                    </div>
                    <div class="form-group mb-3">
                        <label for="semester">Semester</label>
                        <input type="number" class="form-control {{ $errors->has('semester') ? 'is-invalid' : '' }}" id="semester" name="semester" min="1" max="14" required>
...
<!-- Modal Edit -->
<div class="modal fade" id="modal-edit" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalEditId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="form-edit">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_kode_matakuliah" name="kode_matakuliah" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="edit_nama_matakuliah">Nama Mata Kuliah</label>
                        <input type="text" class="form-control" id="edit_nama_matakuliah" name="nama_matakuliah" required>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" id="edit_semester" name="semester" min="1" max="14" required>
                    </div>
                    <div class="form-group mb-3">
