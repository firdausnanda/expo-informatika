        ...
        <div class="row mb-4">
            <div class="col-12">
                <h2 class="section-title">
                    ...
                    <small class="text-muted">({{ $tahun_akademik->tahun_akademik }} - {{ $tahun_akademik->semester }})</small>
                </h2>
            </div>
        </div>

        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
            @forelse ($matakuliah->projects as $project)
            ...
            @empty
                <div class="col-12">
                    <div class="alert alert-info">
                        Belum ada project untuk mata kuliah ini
                    </div>
                </div>
            @endforelse
        </div>
