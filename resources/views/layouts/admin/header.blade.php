        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('landing/img/logo.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('landing/img/logo.png') }}" alt="" height="25">
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon waves-effect"
                    ...
                    <span class="badge bg-danger rounded-pill">{{ $contactUsCount }}</span>
                </button>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <a href="javascript: void(0);" class="text-reset notification-item">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1" key="t-shipped">{{ $item->subject }}</h6>
                                        <div class="font-size-12 text-muted">
                                            <p class="mb-1" key="t-grammer">{{ Str::limit($item->message, 25) }}</p>
