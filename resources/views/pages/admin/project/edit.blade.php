                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="tahun_akademik" id="tahun_akademik" class="form-select">
                                                ...
                                                <option value="{{ $project->id_tahun_akademik }}" selected>
                                                    {{ $project->tahun_akademik->tahun_akademik }} -
                                                    {{ $project->tahun_akademik->semester }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="matakuliah" id="matakuliah" class="form-select">
                                                ...
                                                <option value="{{ $project->id_matakuliah }}" selected>
                                                    {{ $project->matakuliah->nama_matakuliah }} -
                                                    {{ $project->matakuliah->kode_matakuliah }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Add Mahasiswa to Table
            var rawData = '{!! $mahasiswa !!}';
            var mahasiswaData = safeJsonParse(rawData);
            ...
            mahasiswaData.forEach(function(item) {
                table.row.add({
                    ...
                    prodi: item.prodi,
                    angkatan: item.angkatan,
                    action: '<button class="btn btn-danger btn-sm hapus-mahasiswa" data-id="' + item
                        .id + '">Hapus</button>'
                });
            });
            table.draw();
